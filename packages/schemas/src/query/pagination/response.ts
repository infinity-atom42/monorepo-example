...
type OptionalizeSelectedShape<TBaseShape extends z.ZodRawShape, TSelectableShape extends z.ZodRawShape> = {
	[K in keyof TBaseShape]: K extends keyof TSelectableShape ? z.ZodOptional<TBaseShape[K]> : TBaseShape[K]
}
...
>(baseSchema: TBase, options?: { selectable?: TSelectable; includable?: TRelations }) {
	...
	const item = z.strictObject(itemShape as unknown as ReturnItemShape<TBase, TSelectable, TRelations>)
