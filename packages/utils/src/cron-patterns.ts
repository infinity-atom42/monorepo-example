...
const FunctionExpressions = {
	 ...
	 * @param {number} minutes
	 */
	everyHoursAt(hours: number, minutes = 0) {
	 ...
	 */
	everySecond() {
		return ConstantExpressions.EVERY_SECOND
	},
	/**
	 ...
	 */
	everyMinute() {
		return ConstantExpressions.EVERY_MINUTE
	},
	/**
	 ...
	 */
	hourly() {
		return ConstantExpressions.EVERY_HOUR
	},
	/**
	 ...
	 */
	daily() {
		return ConstantExpressions.EVERY_DAY_AT_MIDNIGHT
	},
	/**
	 ...
	 */
	everyWeekday() {
		return ConstantExpressions.EVERY_WEEKDAY
	},
	/**
	 ...
	 */
	everyWeekend() {
		return ConstantExpressions.EVERY_WEEKEND
	},
	/**
	 ...
	 */
	weekly() {
		return ConstantExpressions.EVERY_WEEK
	},
	/**
	 ...
	 */
	monthly() {
		return ConstantExpressions.EVERY_1ST_DAY_OF_MONTH_AT_MIDNIGHT
	},
	/**
	 ...
	 */
	everyQuarter() {
		return ConstantExpressions.EVERY_QUARTER
	},
	/**
	 ...
	 */
	yearly() {
		return ConstantExpressions.EVERY_YEAR
	},
}
