...
import { useComposedRefs } from '@packages/table_v1/lib/compose-refs'
...
function SortableOverlay(props: SortableOverlayProps) {
	const { container: containerProp, children, modifiers: modifiersProp, ...overlayProps } = props
	...
	const modifiers = modifiersProp ?? context.modifiers

	return ReactDOM.createPortal(
		<DragOverlay
			dropAnimation={dropAnimation}
			{...omitUndefined({ modifiers })}
