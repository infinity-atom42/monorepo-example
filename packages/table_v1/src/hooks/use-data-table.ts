...
import { getSortingStateParser } from '@packages/table_v1/lib/parsers'
import type { ExtendedColumnSort, QueryKeys } from '@packages/table_v1/types/table'
...
import { useReactTableWrapper } from './use-react-table-wrapper'
...
export function useDataTable<TData>(props: UseDataTableProps<TData>) {
	...
	// TODO: Switch back to useReactTable directly once React Compiler compatibility is resolved
	// @see https://github.com/TanStack/table/issues/5567
	const table = useReactTableWrapper({
		...tableProps,
		columns,
		...omitUndefined({ initialState }),
		pageCount,
		state: {
			pagination,
			sorting,
